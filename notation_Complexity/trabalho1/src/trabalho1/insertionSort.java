...
public class insertionSort {
    ...
    //ORDENATION method (insertion sort)
    ...
    public static void secondMethod() throws IOException {
        ...
        f1.abreEscrita("graficos/Insertion sort.csv"); //create file
        f1.escreveLinha("EXECUTION TIME FOR second ORDENATION METHOD (based on insertion sort)\n");
